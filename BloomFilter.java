...
public class BloomFilter {
	...
	public boolean query(String s){
		...
		//ArrayList<Integer> temp = new ArrayList<Integer>();//array list to store number of each character
		//ArrayList<Character> temp2 = new ArrayList<Character>();//array list to store each character
		//arrayLists used because the length of the string is unknown, and using an ascii array would waste space?
