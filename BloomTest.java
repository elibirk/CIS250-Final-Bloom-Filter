...
public class BloomTest {
	...
	public static boolean contains(ArrayList<String> string, String s) {
	    for (int a = 0; a < string.size(); a++){//iterate through array
	        if (string.get(a).equals(s)){//if array value is s, return true
	            return true;
	        }//end if
	    }//end for
